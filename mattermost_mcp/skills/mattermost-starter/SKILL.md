---
name: mattermost-starter
description: >-
  Mattermost API + MCP Server + A2A Server Use when working with Mattermost via this package's MCP
...
license: MIT
tags: [mattermost-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Mattermost Starter Skill

Starter skill for the **Mattermost** package. Use the `mcp-client` universal skill
