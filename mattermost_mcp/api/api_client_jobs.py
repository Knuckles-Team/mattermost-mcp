...
class Api(ApiClientBase):
    ...
    def get_job(self, job_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/jobs/{job_id}".format(job_id=job_id)
        return self.request("GET", url, params=kwargs)
    ...
    def download_job(self, job_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/jobs/{job_id}/download".format(job_id=job_id)
        return self.request("GET", url, params=kwargs)
    ...
    def cancel_job(self, job_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/jobs/{job_id}/cancel".format(job_id=job_id)
        return self.request("POST", url, data=kwargs)
    ...
    def get_jobs_by_type(self, job_type: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/jobs/type/{job_type}".format(job_type=job_type)
        return self.request("GET", url, params=kwargs)
    ...
    def update_job_status(self, job_id: str, **kwargs) -> Any:
        ...
        Method: PATCH
        """
        url = "/api/v4/jobs/{job_id}/status".format(job_id=job_id)
