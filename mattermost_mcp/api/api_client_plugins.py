...
class Api(ApiClientBase):
    ...
    def remove_plugin(self, plugin_id: str, **kwargs) -> Any:
        ...
        Method: DELETE
        """
        url = "/api/v4/plugins/{plugin_id}".format(plugin_id=plugin_id)
    ...
    def enable_plugin(self, plugin_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/plugins/{plugin_id}/enable".format(plugin_id=plugin_id)
        return self.request("POST", url, data=kwargs)
    ...
    def disable_plugin(self, plugin_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/plugins/{plugin_id}/disable".format(plugin_id=plugin_id)
        return self.request("POST", url, data=kwargs)
    ...
    def detach_plugin(self, plugin_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/plugins/{plugin_id}/detach".format(plugin_id=plugin_id)
        return self.request("POST", url, data=kwargs)
