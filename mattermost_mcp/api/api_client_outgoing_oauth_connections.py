...
class Api(ApiClientBase):
    ...
    def get_outgoing_o_auth_connection(
        self, outgoing_oauth_connection_id: str, **kwargs
    ) -> Any:
        """Get a connection
        ...
        Method: GET
        """
        url = f"/api/v4/oauth/outgoing_connections/{outgoing_oauth_connection_id}"
        return self.request("GET", url, params=kwargs)
    ...
    def delete_outgoing_o_auth_connection(
        self, outgoing_oauth_connection_id: str, **kwargs
    ) -> Any:
        """Delete a connection
