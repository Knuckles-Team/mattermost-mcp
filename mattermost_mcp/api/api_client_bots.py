...
class Api(ApiClientBase):
    ...
    def get_bot(self, bot_user_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/bots/{bot_user_id}".format(bot_user_id=bot_user_id)
        return self.request("GET", url, params=kwargs)
    ...
    def disable_bot(self, bot_user_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/bots/{bot_user_id}/disable".format(bot_user_id=bot_user_id)
        return self.request("POST", url, data=kwargs)
    ...
    def enable_bot(self, bot_user_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/bots/{bot_user_id}/enable".format(bot_user_id=bot_user_id)
        return self.request("POST", url, data=kwargs)
    ...
    def assign_bot(self, bot_user_id: str, user_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/bots/{bot_user_id}/assign/{user_id}".format(bot_user_id=bot_user_id, user_id=user_id)
        return self.request("POST", url, data=kwargs)
    ...
    def convert_bot_to_user(self, bot_user_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/bots/{bot_user_id}/convert_to_user".format(bot_user_id=bot_user_id)
        return self.request("POST", url, data=kwargs)
