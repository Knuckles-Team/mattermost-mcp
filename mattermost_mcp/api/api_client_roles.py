...
class Api(ApiClientBase):
    ...
    def get_role(self, role_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/roles/{role_id}".format(role_id=role_id)
        return self.request("GET", url, params=kwargs)
    ...
    def get_role_by_name(self, role_name: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/roles/name/{role_name}".format(role_name=role_name)
        return self.request("GET", url, params=kwargs)
    ...
    def patch_role(self, role_id: str, **kwargs) -> Any:
        ...
        Method: PUT
        """
        url = "/api/v4/roles/{role_id}/patch".format(role_id=role_id)
