...
class Api(ApiClientBase):
    ...
    def get_recap(self, recap_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/recaps/{recap_id}".format(recap_id=recap_id)
        return self.request("GET", url, params=kwargs)
    ...
    def mark_recap_as_read(self, recap_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/recaps/{recap_id}/read".format(recap_id=recap_id)
        return self.request("POST", url, data=kwargs)
    ...
    def regenerate_recap(self, recap_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/recaps/{recap_id}/regenerate".format(recap_id=recap_id)
        return self.request("POST", url, data=kwargs)
