...
class Api(ApiClientBase):
    ...
    def get_o_auth_app(self, app_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/oauth/apps/{app_id}".format(app_id=app_id)
        return self.request("GET", url, params=kwargs)
    ...
    def regenerate_o_auth_app_secret(self, app_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = "/api/v4/oauth/apps/{app_id}/regen_secret".format(app_id=app_id)
        return self.request("POST", url, data=kwargs)
    ...
    def get_o_auth_app_info(self, app_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/oauth/apps/{app_id}/info".format(app_id=app_id)
        return self.request("GET", url, params=kwargs)
    ...
    def get_authorized_o_auth_apps_for_user(self, user_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/users/{user_id}/oauth/apps/authorized".format(user_id=user_id)
        return self.request("GET", url, params=kwargs)
