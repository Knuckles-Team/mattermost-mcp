...
class Api(ApiClientBase):
    ...
    def post_c_f_post_flag(self, post_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = f"/api/v4/content_flagging/post/{post_id}/flag"
    ...
    def get_c_f_post_field_values(self, post_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = f"/api/v4/content_flagging/post/{post_id}/field_values"
        return self.request("GET", url, params=kwargs)
    ...
    def get_c_f_post(self, post_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = f"/api/v4/content_flagging/post/{post_id}"
        return self.request("GET", url, params=kwargs)
    ...
    def remove_c_f_post(self, post_id: str, **kwargs) -> Any:
        ...
        Method: PUT
        """
        url = f"/api/v4/content_flagging/post/{post_id}/remove"
    ...
    def keep_c_f_post(self, post_id: str, **kwargs) -> Any:
        ...
        Method: PUT
        """
        url = f"/api/v4/content_flagging/post/{post_id}/keep"
        return self.request("PUT", url, data=kwargs)
    ...
    def search_c_f_team_reviewers(self, team_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = f"/api/v4/content_flagging/team/{team_id}/reviewers/search"
        return self.request("GET", url, params=kwargs)

    def post_c_f_post_reviewer(
        self, post_id: str, content_reviewer_id: str, **kwargs
    ) -> Any:
        ...
        Method: POST
        """
        url = f"/api/v4/content_flagging/post/{post_id}/assign/{content_reviewer_id}"
        return self.request("POST", url, data=kwargs)
    ...
    def generate_c_f_post_report(self, post_id: str, **kwargs) -> Any:
        ...
        Method: POST
        """
        url = f"/api/v4/content_flagging/post/{post_id}/report"
        return self.request("POST", url, data=kwargs)
