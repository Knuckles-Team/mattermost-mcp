...
class Api(ApiClientBase):
    ...
    def get_emoji(self, emoji_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/emoji/{emoji_id}".format(emoji_id=emoji_id)
        return self.request("GET", url, params=kwargs)
    ...
    def get_emoji_by_name(self, emoji_name: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/emoji/name/{emoji_name}".format(emoji_name=emoji_name)
        return self.request("GET", url, params=kwargs)
    ...
    def get_emoji_image(self, emoji_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/emoji/{emoji_id}/image".format(emoji_id=emoji_id)
        return self.request("GET", url, params=kwargs)
