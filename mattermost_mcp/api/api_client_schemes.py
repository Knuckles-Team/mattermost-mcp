...
class Api(ApiClientBase):
    ...
    def get_scheme(self, scheme_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/schemes/{scheme_id}".format(scheme_id=scheme_id)
        return self.request("GET", url, params=kwargs)
    ...
    def patch_scheme(self, scheme_id: str, **kwargs) -> Any:
        ...
        Method: PUT
        """
        url = "/api/v4/schemes/{scheme_id}/patch".format(scheme_id=scheme_id)
    ...
    def get_teams_for_scheme(self, scheme_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/schemes/{scheme_id}/teams".format(scheme_id=scheme_id)
        return self.request("GET", url, params=kwargs)
    ...
    def get_channels_for_scheme(self, scheme_id: str, **kwargs) -> Any:
        ...
        Method: GET
        """
        url = "/api/v4/schemes/{scheme_id}/channels".format(scheme_id=scheme_id)
        return self.request("GET", url, params=kwargs)
